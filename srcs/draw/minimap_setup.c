...
/*   Updated: 2025/10/17 18:14:33 by sbehar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub.h"

void	ft_draw_one_minimap_cell(t_value *value, t_minimap *minimap, int x, int y)
{
	t_color	color;

	ft_update_map_pos(value->player, minimap, x, y);
